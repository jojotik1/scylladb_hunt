...
def _load_mock_data() -> dict:
    """Load mock data from apollo_mock_data.json, searching common locations."""
    candidates = [
        os.path.join(os.path.dirname(__file__), "apollo_mock_data.json"),
        os.path.join(os.path.dirname(__file__), "src", "data", "apollo_mock_data.json"),
        "apollo_mock_data.json",
    ]
    ...
    raise FileNotFoundError(
        "apollo_mock_data.json not found. Place it alongside apollo.py or in src/data/."
    )
